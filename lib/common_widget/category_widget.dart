...
class CategoryWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ContainerDecorated(color: loading!=null?null:Colors.pinkAccent.shade100.withOpacity(0.1),borderRadius: 15,child: ImageCommon( image!=null?image! : DateTime.timestamp().millisecond.isEven?AppImagesConst.vegitable2: AppImagesConst.vegitable,height: height??75,width: width??75,),),
