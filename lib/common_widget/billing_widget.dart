...
class BillingWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ContainerDecorated(borderRadius: 15,padding: 8,color: Colors.white,child: Column(children: [
      ...
      const Divider(),
      customRow(const SmallText(text: "Handling Fee (incl GST)",fontWeight: FontWeight.w500), const SmallText(text: "₹5",fontWeight: FontWeight.w500,)),
      const Divider(),
      false?SizedBox():customRow(const Expanded(flex: 3,
