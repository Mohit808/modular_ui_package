          ...
          children: [
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
                BigText20(text: heading??"Monsoon's Exotic \nHarvest!",color: Colors.white,),
                const SizedBox(height: 16,),
                SmallText(text: description??"Up to 30% OFF on fruits that \nare too good to last forever",color: Colors.white,fontWeight: FontWeight.w500,),
                const SizedBox(height: 16,),
            ...
            image.runtimeType!=String?image:isNetworkImage!=null?NetworkOrAssetImage(src:image,height: 150,width: 150):Image.asset(image?? "assets/images/vegitable.png",height: 150,width: 150,fit: BoxFit.cover,),
