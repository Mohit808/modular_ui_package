  ...
  Widget build(BuildContext context) {
    return
      ...
      Row(crossAxisAlignment: CrossAxisAlignment.start,children: [
        ContainerDecorated(elevation: 2,padding: 2,color: AppColors.primary,borderRadius: 50,child: SizedBox(height: 50,width: 50,child: NetworkOrAssetImage(src: AppImagesConst.user,))),
        SizedBox(width: 8,),
        Expanded(
